...
// ── Define your Asia territories (interactive regions) ──
const asiaTerritories = [
  "Indonesia",
  "NewGuinea",
  "Siam",
  "India",
...
const AsiaDaf = () => {
  ...
  const [regions2, setRegions2] = useState({
    ...
    // Asia regions (retain grey color and text property)
    ...
    Ural: { color: 'black' }, // Ural is set to black in your regions2
  });
  ...
  const handleTerritoryClick = (region) => {
    // Only allow clicks if the region is one of the Asia territories
    if (!asiaTerritories.includes(region)) {
      // Optionally, you could show a message:
      // showMessage('This territory is not interactive.');
      return;
    }
...
const lose = async () => {
  ...
  const TerritoryComponent = ({ name, data }) => {
    ...
    // Determine whether the territory is interactive (Asia) or not.
    const isInteractive = asiaTerritories.includes(name);
    
    return (
      <div
        className={`territory-container ${name} ${!isInteractive ? 'non-interactive' : ''}`}
        ref={el => (territoriesRef.current[name] = el)}
        onClick={() => { if (isInteractive) handleTerritoryClick(name); }}
      >
  ...
  return (
    <div className="daf-container">
      ...
      <div>
        <img src={dot} alt="Second image" className="linebrazil" />
        <img src={dot} alt="Second image" className="linemad1" />
        <img src={dot} alt="Second image" className="brit1" />
        <img src={dot} alt="Second image" className="brit2" />
        <img src={dot} alt="Second image" className="brit3" />
        <img src={dot} alt="Second image" className="brit4" />
        <img src={dot} alt="Second image" className="egypteu" />
        <img src={dot} alt="Second image" className="brit5" />
        <img src={dot} alt="Second image" className="green" />
        <img src={dot} alt="Second image" className="jap1" />
        <img src={dot} alt="Second image" className="jap2" />
        <img src={dot} alt="Second image" className="linemad2" />
        <img src={dot} alt="Second image" className="middleeastline" />
        <img src={dot} alt="Second image" className="lineindonesia" />
        <img src={dot} alt="Second image" className="siamline" />
        <img src={dot} alt="Second image" className="linenew" />
        <img src={dot} alt="Second image" className="newindo" />
        <img src={dot} alt="Second image" className="westnew" />
      </div>
...
<div>
      ...
      <div className="BackIconContainer">
        <button onClick={LeaveRoom} className="icon-button">
          <img src={`${process.env.PUBLIC_URL}/Images/Leave.png`} alt="Leave" className="icon-image" />
        </button>
      </div>
